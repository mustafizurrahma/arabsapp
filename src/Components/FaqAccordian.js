...
function ContextAwareToggle({ children, eventKey, callback }) {
  ...
  console.log("🚀 ~ file: FaqAccordian.js ~ line 9 ~ ContextAwareToggle ~ activeEventKey", activeEventKey)
          ...
          <Accordion.Collapse eventKey="0">
            <ScrollAnimation className="animate__animated animate__zoomIn">
              <Card.Body>
                ...
                <p>
                  <span>4.</span> Choose the # of The First Arabs NFTs you’d like to mint by using the arrows on the "Mint” button (button will be activated upon launch).
                </p>
                <p>
